...
public class DashboardService {
    ...
    private ReceitaDespesaDTO buscarResumoFinanceiroMes(){
        ...
        BigDecimal despesasRecorrentes = transacaoRepository
                .calcularTotalMesRecorrentePorTipo(TipoTransacao.DESPESA, inicio, fim);

        dto.setSaldoMes(saldoMes);
        dto.setSaldoAtual(saldoAtual);
        dto.setReceitasMes(receitas);
        dto.setDespesasMes(despesas);
        dto.setDespesasRecorrentesMes(despesasRecorrentes);
        return dto;
    }
