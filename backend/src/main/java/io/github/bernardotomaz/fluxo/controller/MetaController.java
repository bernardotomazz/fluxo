...
import io.github.bernardotomaz.fluxo.dto.request.AporteMetaRequestDTO;
...
public class MetaController {
    ...
    public MetaResponseDTO adicionarAporte(@PathVariable Long id,
                                           @Valid @RequestBody AporteMetaRequestDTO aporte) {
        return metaService.adicionarAporte(id, aporte.getValor());
    }
