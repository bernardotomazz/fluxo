...
public class ReceitaDespesaDTO {
    ...
    private BigDecimal despesasRecorrentesMes;
    ...
    public BigDecimal getDespesasRecorrentesMes() {
        return despesasRecorrentesMes;
    }

    public void setDespesasRecorrentesMes(BigDecimal despesasRecorrentesMes) {
        this.despesasRecorrentesMes = despesasRecorrentesMes;
    }
}